...
<table>
    <tr>
        <td style="max-width: 100%; background-color: darkslategrey; color: darkslategrey" > <img src="docs/solana-agent-kit/assets/sendai-logo.png" alt="Icon" width="64" height="auto" style="max-width: 100%; background-color: darkslategrey; color: darkslategrey" /> </td>
